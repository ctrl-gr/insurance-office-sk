...
class insurance_position_plugin:
    ...
    def add_insurance(
        ...
        policy_type: Annotated[str, "Type of insurance (e.g., Health, Auto, Home, Life)"],
        ...
        try:
            ...
            return f"Successfully added insurance policy for '{policy_holder}' (ID: {result.inserted_id})"
